...
function addRow(frm) {
rowNum ++;
var row = '<hr><div><p id="rowNum'+rowNum+'">Item: <input type="text" name="iname[]" size="2" value="'+frm.i_name.value+'">Quantity: <input type="text" name="iqty[]" size="2" value="'+frm.qty.value+'">Price: <input type="text" name="iprice[]" size="2" value="'+frm.price.value+'"><br><br><input  type="button" class="btn btn-danger" value="-Remove" onclick="removeRow('+rowNum+');"><br></p></div>';
...
$sql = "INSERT INTO inventory_stock_hotel (date, item, qty, price) VALUES ('$date',N'$a', '".$_POST['iqty'][$cnt]."', '".$_POST['iprice'][$cnt]."');";
