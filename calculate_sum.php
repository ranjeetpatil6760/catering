...
$("table tbody").on("keyup", ".txt", function () {
    calculateSum();
});
...
?>
	...
	<option>dozen</option>
        ...
        <input type="text" id="price" placeholder="Price" class="txt">
        <input id="dues" type="text" placeholder="Dues" class="txt"  >
    ...
    <button type="button" class="delete-row btn btn-primary">Delete Row</button><br><br>
				 ...
				 <input type="text" name="Subtotal" id="sum" >	 
		...
		<div class="form-actions" >
			...
			<input type="submit" name="but" value="Submit"/>
								...
								<button class="btn" name="save">Cancel</button>
									<!--/span--></fieldset>
			</form>
									<?php
									include "db.php";
...
$qry="INSERT INTO stock_hotel_details (date, subtotal, total_dues) VALUES ('$date','$Subtotal', '$tt')";
