...
Item Quantity: <input type="text" name="add_qty" size="4" /> Item Price: <input type="text" name="add_price" /> <input onclick="addRow(this.form);" type="button" value="Add row" />
</div>
<script type="text/javascript">
var rowNum = 0;
function addRow(frm) {
rowNum ++;
var row = '<p id="rowNum'+rowNum+'">Item name: <input type="select" name="name[]" size="4" value="'+frm.item_name.value+'">Item quantity: <input type="text" name="qty[]" size="4" value="'+frm.add_qty.value+'"> Item Price: <input type="text" name="price[]" value="'+frm.add_price.value+'"> <input type="button" value="Remove" onclick="removeRow('+rowNum+');"></p>';
